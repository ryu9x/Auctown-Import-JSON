...
function fetchData(){
	...
	$.get(fetchJSONData.descriptionModule.descriptionUrl,function(responseHTML){
		...
		customDesc += $('#summernote_temp_desc').val().replace("#desc-heading",fetchJSONData.titleModule.subject).replace("#desc-body",responseHTML).replace(".shipping-schedule",$("#summernote_temp_shipping_time").val());
		...
		$("#summernote_desc").val(customDesc);
...
function loadSummernote(){
	try{
		...
		$('#summernote_temp_desc').val('<table width="100%" cellspacing="0" cellpadding="10" border="0"><tbody><tr><th><div id="desc-heading"><h6>#desc-heading</h6></div></th></tr><tr><td bgcolor="#60992e"><strong> <span style="COLOR: #FFFFFF;">出品物</span> </strong></td></tr><tr><td><div id="note" class="shipping-schedule">.shipping-schedule</div></td></tr><tr><td><div id="desc-body">#desc-body</div></td></tr></tbody></table>');
