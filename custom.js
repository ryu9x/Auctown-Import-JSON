...
function fetchData(){
	...
	$.get(fetchJSONData.descriptionModule.descriptionUrl,function(responseHTML){
		var customDesc = "";
		customDesc += $("#summernote_desc").val($('#summernote_temp_desc').val().replace("#desc-heading",fetchJSONData.titleModule.subject));
...
function loadSummernote(){
	try{
		$('#summernote_temp_desc').val('<table width="100%" cellspacing="0" cellpadding="10" border="0"><tbody><tr><th><div id="desc-heading"><h3>#desc-heading</h3></div></th></tr><tr><td bgcolor="#60992e"><strong> <span style="COLOR: #FFFFFF;">出品物</span> </strong></td></tr><tr><td><div id="desc-note">#desc-note</div></td></tr><tr><td><div id="desc-body">#des-body</div></td></tr></tbody></table>');
